...
Dự án sử dụng PostgreSQL. Bạn cần đảm bảo đã cài đặt và có một database server đang hoạt động.

Tạo một tệp tin cấu hình môi trường tên là .env ở thư mục gốc của dự án và điền thông tin kết nối database:
